...
Sina Zaker
        ...
        >
          My linkedin
        <img className="icons" src="https://img.icons8.com/ios-glyphs/50/000000/linkedin.png"/>
        </a>
        </div>
        ...
        >
          My github
          <img className="icons" src="https://img.icons8.com/ios-glyphs/30/000000/github.png"/>
        </a>
        </div>
...
<div class="img-container-div">
        ...
        >
          My codewars
          <img className="icons" src="https://www.codewars.com/packs/assets/logo.61192cf7.svg"/>
        </a>
        </div>
        ...
        >
          My Facebook
          <img className="icons" src="https://img.icons8.com/office/16/000000/facebook-new.png"/>
        </a>
        </div>
